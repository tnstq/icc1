      ...
      <div class="one" v-if="myPage==1">
        <ul>
          <li>
            ...
            <div class="text" @click="news14">
              News | Competition Rules of the 2022-2023 Invention Convention China
            </div>
            <span v-if="!big">2023-03-18</span>
          </li>
          <li>
            <div class="data" v-if="big">
